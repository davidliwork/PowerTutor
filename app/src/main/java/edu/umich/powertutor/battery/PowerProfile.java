...
public class PowerProfile {
    ...
    private void readPowerValuesFromXml(Context context) {
        ...
        try {
            int id = ReflectionUtils.getId("xml", "power_profile");
            ...
            int[] configResIds = new int[]{
                    ReflectionUtils.getId("integer", "config_bluetooth_idle_cur_ma"),
                    ReflectionUtils.getId("integer", "config_bluetooth_rx_cur_ma"),
                    ReflectionUtils.getId("integer", "config_bluetooth_tx_cur_ma"),
                    ReflectionUtils.getId("integer", "config_bluetooth_operating_voltage_mv"),
                    ReflectionUtils.getId("integer", "config_wifi_idle_receive_cur_ma"),
                    ReflectionUtils.getId("integer", "config_wifi_active_rx_cur_ma"),
                    ReflectionUtils.getId("integer", "config_wifi_tx_cur_ma"),
                    ReflectionUtils.getId("integer", "config_wifi_operating_voltage_mv"),
            };
